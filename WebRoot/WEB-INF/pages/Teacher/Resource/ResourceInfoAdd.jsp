  ...
  <body>
        <div class="container">
          ...
          <div id="forms" class="mt10">
					<div class="box_border" id="ResourceInfoAdd">
		          			<div class="box_top"><b class="pl15">新增资源信息</b></div>
    ...
    <script type="text/javascript">
       ...
       $(function(){
		...
		$.post("${pageContext.request.contextPath}/Teacher/ResourceInfoAdd",$("#ResourceInfoForm").serialize(),
			function(data){											
						if (data.split("|")[0] != "0"){
							alert("添加成功!");
        ...
        parent.window.setLocation("${subjectInfo.subject} - 设置--新增资源");
    </script>
  </body>
