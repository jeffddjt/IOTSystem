		...
		<div id="forms" class="mt10">
			<div class="box">
				<div class="box_border" id="question">
                    ...
                    <div class="box_top"><b class="pl15">单选题信息</b></div>
                    <div class="box_center">
                            ...
                            <tr>
                            	...
                            	<td>
                            		<select name="type" id="typeSelector" disabled="disabled">
	...
	var editor=CKEDITOR.replace("questionName${question.type}");
  	...
  	$(function () {
           ...
           $("#choiceB1").uploadify({
            ...
            $.post("${pageContext.request.contextPath}/Teacher/QuestionUpdate",$("#questionForm${question.type}").serialize(),function(data){
            	if(data.split("|")[0]=="0"){
            		alert(data.split("|")[1]);
            	}else {
            		alert("修改成功!");
