...
<html>
  ...
  <body>
        ...
        <div id="button" class="mt10">
            <input type="button" name="button" class="btn btn82 btn_add" value="新增"  onclick="window.location.href = '${pageContext.request.contextPath}/Teacher/VrpQuestionAdd?subject=${subject}'" />
                ...
                <form id="questionForm">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table"> 
                        ...
                        <tr class="tr" >
                            ...
                            <td ><a class="questionItem" href="Teacher/VrpQuestionUpdate?id=${question.id}&pageNo=${pageNo}">${question.itemText}</a></td>
       ...
       function SelectAll(){
		...
		function deleteQuestion(){
			if(!confirm("真的要删除这些题目吗？"))
				return;
			$.post("Teacher/VrpQuestionDelete",$("#questionForm").serialize(),
			function(data){						
						if (data.split("|")[0] != "0")
