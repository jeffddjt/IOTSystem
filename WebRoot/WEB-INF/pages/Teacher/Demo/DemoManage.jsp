...
<html>
  ...
  <body>
        ...
        <div id="button" class="mt10">
            <input type="button" name="button" class="btn btn82 btn_add" value="新增"  onclick="window.location.href = '${pageContext.request.contextPath}/Teacher/DemoAdd?subject=${subjectInfo.id}'" />
            ...
            <div class="box span10 oh">
                ...
                <form id="resourceInfoForm">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table"> 
                        ...
                        <tr class="tr" >
                            <td class="td_center">
                                <input type = "checkbox" name="selected" value="${demo.id}">
                            </td >
                            <td><a class="questionItem" href="Teacher/DemoUpdate?id=${demo.id}">${demo.name}</a></td>
                ...
                <div class="page mt10">
                    <div class="pagination">
						<bh:BHPager pageNo="${pageNo}" url="Teacher/DemoManage?subject=${subjectInfo.id}"  pageCount="${pageCount}"/>
                    </div>
       ...
       function SelectAll(){
		...
		function deleteResourceInfo(){
			if(!confirm("真的要删除这些资源吗？"))
				return;
			$.post("${pageContext.request.contextPath}/Teacher/DemoDelete",$("#resourceInfoForm").serialize(),
			function(data){						
						if (data.split("|")[0] != "0")
						{
							alert(data.split("|")[1]);
