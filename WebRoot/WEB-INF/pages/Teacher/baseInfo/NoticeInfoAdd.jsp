  ...
  <body>
        ...
        <form id="form1">
            <div class="box">
                <div class="box_border">
                    <div class="box_top"><b class="pl15">添加通知</b></div>
                    <div class="box_center">
                            <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="td_right">标题：</td>
                                    <td class="">
                                        <div style="float:left"><input type="text" id="title" name="title" class="input-text lh30" size="70" /></div>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        ...
                                        <textarea rows="40" cols="150" id="editor" style="width:1024px;height:500px;"></textarea>
                                        <input type="hidden" id="content" name="content" /></div>
    ...
    <script type="text/javascript">
        ...
        function btnSave()
        {
            ...
            $.post('${pageContext.request.contextPath}/Teacher/NoticeInfoAdd',$("#form1").serialize(),function(data){
            	if(data.split("|")[0]!="0"){
            		alert("保存成功！");
        ...
        parent.window.setLocation("基础信息 -- 通知管理 -- 添加通知")
    </script>
  </body>
</html>
