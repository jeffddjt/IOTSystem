  ...
  <body>
                        	...
                        	<form id="ResourceInfoForm" class="resourceInfoForm"  method="post">   
		          					<table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
		          						<tr>
		          							...
		          							<td width="600">
		          								<input type="text" id="videoName" name="name" class="textarea" style="width:600px;height:20px;" value="${enterpriseVideo.name}">
		          							</td>
		          							<td></td>
		          						</tr>	          						
		          						...
		          						<tr>
		          							...
		          							<td width="600">
		          								...
		          								<input type="hidden" id="videoPath" name="path" value="${enterpriseVideo.path}">
		          								<input type="hidden" name="id" value="${enterpriseVideo.id }">
		          								<input type="hidden" name="type" value="9999">		          								
		          								<div id="player"></div>
		          							</td>
		          							<td></td>
		          						</tr>	          						
    ...
    <script type="text/javascript">
     $(function(){          
        ...
        setPlayer("${pageContext.request.contextPath}/${enterpriseVideo.path}");
		...
		$.post("${pageContext.request.contextPath}/Teacher/EnterpriseVideoUpdate",$("#ResourceInfoForm").serialize(),
			function(data){											
						if (data.split("|")[0] != "0"){
							alert("修改成功!");
        ...
        parent.window.setLocation("${title}--修改");
    </script>
  </body>
</html>