...
<html>
  ...
  <body>
        ...
        <div id="button" class="mt10">
            <input type="button" name="button" class="btn btn82 btn_add" value="新增"  onclick="window.location.href = '${pageContext.request.contextPath}/Teacher/TroubleAdd'" />
            ...
            <div class="box span10 oh">
                ...
                <form id="resourceInfoForm">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table"> 
                        ...
                        <tr class="tr" >
                            <td class="td_center">
                                <input type = "checkbox" name="selected" value="${trouble.id}">
                            </td >
                            <td><a class="questionItem" href="Teacher/TroubleUpdate?id=${trouble.id}">${trouble.name}</a></td>
                ...
                <div class="page mt10">
                    <div class="pagination">
						<bh:BHPager pageNo="${pageNo}" url="Teacher/TroubleManage?"  pageCount="${pageCount}"/>
                    </div>
