        ...
        <div class="container">
          ...
          <div id="forms" class="mt10">
					<div class="box_border" id="ResourceInfoAdd">
		          			<div class="box_top"><b class="pl15">值班故障</b></div>
		          			<div class="box_center">
                        	<form id="ResourceInfoForm" class="resourceInfoForm"  method="post">   
		          					<table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
		          						<tr>
		          							<td class="td_right" style="vertical-align:top;">故障名称：</td>
		          							<td width="600">
		          								<input type="text" name="name" value="${trouble.name}" class="textarea" style="width:600px;height:20px;">
		          							</td>
		          							<td></td>
		          						</tr>
		          						<tr>
		          							...
		          							<td width="600">
		          								...
		          								<input type="hidden" id="studyConsole" name="study_console" value="${trouble.study_console}">
		          						...
		          						<tr>
		          							...
		          							<td width="600">
		          								...
		          								<input type="text" id="testConsole" name="test_console" class="textarea" style="width:600px;height:20px;" readonly="readonly" value="${trouble.test_console}">
		          							</td>
		          							<td></td>
		          						</tr>
		          						<tr>
		          							...
		          							<td width="600">
		          								...
		          								<input type="text" id="examConsole" name="exam_console" class="textarea" style="width:600px;height:20px;" readonly="readonly" value="${trouble.exam_console}">
		          							</td>
		          							<td></td>
		          						</tr>
		          						<tr>
		          							...
		          							<td width="600">
		          								...
		          								<input type="hidden" id="studyScene" name="study_scene" value="${trouble.study_scene}">
		          						...
		          						<tr>
		          							...
		          							<td width="600">
		          								...
		          								<input type="text" id="testScene" name="test_scene" class="textarea" style="width:600px;height:20px;" readonly="readonly" value="${trouble.test_scene}">
		          							</td>
		          							<td></td>
		          						</tr>
		          						<tr>
		          							...
		          							<td width="600">
		          								...
		          								<input type="text" id="examScene" name="exam_scene" class="textarea" style="width:600px;height:20px;" readonly="readonly" value="${trouble.exam_scene}">
		          							</td>
		          							<td><input type="hidden" name="id" value="${trouble.id}"></td>
		          						</tr>
    ...
    <script type="text/javascript">
     $(function(){
           ...
           $("#studyConsoleFile").uploadify({height: 30,swf: '${pageContext.request.contextPath}/assets/js/uploadfy/uploadify.swf',
               uploader: '${pageContext.request.contextPath}/Teacher/TroubleManage/UpVideoFile',buttonText: '上传视频文件',width: 120,fileObjName:'file',fileTypeExts:'*.flv;*.mp4',multi: true,
           ...
           $("#testConsoleFile").uploadify({height: 30,swf: '${pageContext.request.contextPath}/assets/js/uploadfy/uploadify.swf',
               uploader: '${pageContext.request.contextPath}/Teacher/TroubleManage/UpVrpFile',buttonText: '上传VRP压缩包',width: 120,fileObjName:'file',fileTypeExts:'*.zip',multi: true,
               onUploadSuccess: function (file, data, response) {
        ...
        setPlayer("consolePlayer","${pageContext.request.contextPath}/${trouble.study_console}") ;
        setPlayer("scenePlayer","${pageContext.request.contextPath}/${trouble.study_scene}");
		...
		$.post("${pageContext.request.contextPath}/Teacher/TroubleUpdate",$("#ResourceInfoForm").serialize(),
			function(data){											
						if (data.split("|")[0] != "0"){
							alert("修改成功!");
        ...
        parent.window.setLocation("值班故障处理");
    </script>
  </body>
</html>