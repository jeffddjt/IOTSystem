  ...
  <body>
        <div class="container">
          ...
          <div id="forms" class="mt10">
					<div class="box_border" id="ResourceInfoAdd">
		          			<div class="box_top"><b class="pl15">新增教师</b></div>
                        	...
                        	<form id="ResourceInfoForm" class="resourceInfoForm"  method="post">   
		          					<table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
		          						<tr>
		          							...
		          							<input type="text"  name="account" datatype="*" nullmsg="必须输入账号！" class="textarea"  style="width:600px;height:20px;"  ></td>
		          							<td><div class="Validform_checktip"></div></td>		          							
		          						</tr>
		          						<tr>
		          							<td class="td_right" width="250" style="vertical-align: top">姓名：</td>
		          							<td style="width:600px;">
		          							<input type="text"  name="userName" datatype="*" nullmsg="必须输入姓名！" class="textarea"  style="width:600px;height:20px;"  ></td>
		          							<td><div class="Validform_checktip"></div></td>		          							
		          						</tr>
		          						<tr>
		          							<td class="td_right" width="250" style="vertical-align: top">密码：</td>
		          							<td style="width:600px;">
		          							<input type="password"  name="password" datatype="*" nullmsg="必须输入密码！" class="textarea"  style="width:600px;height:20px;"  ></td>
		          							<td><div class="Validform_checktip"></div></td>		          							
		          						</tr>	          						
		          					</table>
									</form>
    ...
    <script type="text/javascript">
       $(function(){
		...
		$.post("${pageContext.request.contextPath}/Teacher/TeacherInfoAdd",$("#ResourceInfoForm").serialize(),
			function(data){											
						if (data.split("|")[0] != "0"){
							alert("添加成功!");
        ...
        parent.window.setLocation("系统管理--教师管理--新增");
    </script>
  </body>
</html>