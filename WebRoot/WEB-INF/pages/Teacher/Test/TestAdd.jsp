  ...
  <body>
        <div class="container">
          ...
          <div id="forms" class="mt10">
					<div class="box_border" id="TestAdd">
		          			<div class="box_top"><b class="pl15">新增考试</b></div>
                        	...
                        	<form id="TestForm" class="testForm" action="Teacher/TestAdd" method="post">   
		          					<table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
		          						<tr>
		          							...
		          							<input type="text"  id="testName" name="testName" datatype="*" nullmsg="必须输入名称！"  style="width:300px;height:20px;border:1px solid #eee;"  ></td>
		          							<td><div class="Validform_checktip"></div></td>
		          							
		          						</tr>
		          						<tr>
		          							<td class="td_right">单选题数量：</td>
		          							<td><input type="text"  id="SingleQuestionCount" name="singleQuestionCount"  datatype="n" errormsg="数量只能是数字!"  style="width:300px;height:20px;border:1px solid #eee;"  ></td>
		          							<td><div class="Validform_checktip"></div></td>
		          							 
		          						</tr>
		          						<tr>
		          							<td class="td_right">多选题数量：</td>
		          							<td><input type="text"  id="MultipleQuestionCount" name="multipleQuestionCount" datatype="n" errormsg="数量只能是数字!"  style="width:300px;height:20px;border:1px solid #eee;"  ></td>
		          							<td><div class="Validform_checktip"></div></td>
		          							 
		          						</tr>
		          						<tr>
		          							<td class="td_right">判断题数量：</td>
		          							<td><input type="text"  id="WhetherQuestionCount" name="whetherQuestionCount"  datatype="n" errormsg="数量只能是数字!"  style="width:300px;height:20px;border:1px solid #eee;"  ></td>
		          							<td><div class="Validform_checktip"></div></td>
		          							 
		          						</tr>
		          						<tr>
		          							<td class="td_right">VRP虚拟化题数量：</td>
		          							<td><input type="text"  id="VRPQuestionCount" name="vrpQuestionCount" datatype="n" errormsg="数量只能是数字!"  style="width:300px;height:20px;border:1px solid #eee;"  ></td>
		          							<td><div class="Validform_checktip"></div></td> 
		          						</tr>
		          						<tr>
		          							<td class="td_right">考试时间(分钟)：</td>
		          							<td><input type="text"  id="Duration" name="duration" datatype="n" errormsg="考试时间只能是数字!"  style="width:300px;height:20px;border:1px solid #eee;"  ></td>
		          							<td><div class="Validform_checktip"></div></td> 
		          						</tr>
		          						<tr>
		          							<td class="td_right">经验值：</td>
		          							<td><input type="text"  id="Experience" name="experience" datatype="n" errormsg="经验值只能是数字!"  style="width:300px;height:20px;border:1px solid #eee;"  ></td>
		          							<td><div class="Validform_checktip"></div></td> 
		          						</tr>
		          						<tr>
    ...
    <script type="text/javascript">
       $(function(){
		...
		$.post("Teacher/TestAdd",$("#TestForm").serialize(),
			function(data){											
						if (data.split("|")[0] != "0"){
							alert("添加成功!");
        ...
        parent.window.setLocation("${subject} - ${category}测试设置--新增");
    </script>
  </body>
</html>