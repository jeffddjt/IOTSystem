            ...
            <div class="box span10 oh">
                ...
                <form id="resourceInfoForm">
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table"> 
                        ...
                        <tr class="tr" >
                            ...
                            <td><a class="questionItem" href="Student/PollingVideoPlay?id=${pollingVideo.id}">${pollingVideo.name}</a></td>
                ...
                <div class="page mt10">
                    <div class="pagination">
						<bh:BHPager pageNo="${pageNo}" url="Student/PollingVideoView?type=2&"  pageCount="${pageCount}"/>
                    </div>
