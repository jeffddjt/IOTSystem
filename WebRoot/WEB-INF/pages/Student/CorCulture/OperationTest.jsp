...
<html>
  ...
  <body>
  	<iframe width="100%" height="100%" scrolling="none" frameborder="0" src="${pageContext.request.contextPath}/${url}"></iframe>
  
    <script type="text/javascript">
    	parent.window.setLocation("${subjectInfo.subject}--操作训练")
    </script>
  </body>
</html>
